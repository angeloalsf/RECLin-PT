...
% Nomes das listas pré-textuais alinhados aos TCCs de referência do curso
% (LISTA DE FIGURAS / LISTA DE ABREVIATURAS). \listfigurename pertence às
% captions de idioma do abntex2, e por isso precisa entrar via \addto: o babel
% reaplica \captionsbrazil no \begin{document} e desfaria um \renewcommand solto.
\addto\captionsbrazil{\renewcommand{\listfigurename}{Lista de figuras}}
\renewcommand{\listadesiglasname}{Lista de abreviaturas}

% Sumário com os títulos de seção na caixa em que foram escritos, como nos TCCs
% de referência. O iftex.cls aponta \cftsectionfont para \Capitalize, que o
% abntex2abrev define como \uppercase — daí o sumário sair todo em caixa alta.
