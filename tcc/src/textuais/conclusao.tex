...
\textbf{não é estável entre sementes} --- a variação de inicialização de um mesmo
modelo ($0{,}070$ de amplitude no BioBERTpt) supera com folga a diferença entre os
dois modelos ---, mas a direção é: em nenhuma das sementes testadas o \emph{encoder}
clínico fica à frente. O \emph{encoder} geral alcança o clínico com cerca de $60\%$
