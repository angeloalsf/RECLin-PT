...
semente $42$ e não se repete na semente $43$, em que a comparação pareada acusa
diferença significativa --- e em favor do \emph{encoder} clínico. O que \emph{não}
se mantém entre as duas sementes é a \emph{direção}: o sinal da diferença se
inverte. O que se mantém é a \emph{magnitude relativa}: em ambas, a variação de um
...
ganho atribuível ao domínio de pré-treino: não porque o clínico perca, mas porque a
diferença entre os dois não sobrevive à troca de uma semente. Esse achado contrasta
com a expectativa difundida, bem como com os ganhos relatados para o reconhecimento
de entidades nomeadas clínicas em português \cite{schneider_2020_biobertpt}, de que
...
estabilidade: a amplitude entre sementes do BERTimbau na métrica-alvo ($0{,}008$) é
