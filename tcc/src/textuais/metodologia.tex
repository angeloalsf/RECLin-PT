...
dois tipos é o achado relevante: a negação é praticamente adjacente --- em $75\%$
...
predominantes --- \texttt{Abbreviation} ($12\,592$), \texttt{Finding} ($6\,827$),
\texttt{Therapeutic or Preventive Procedure} ($4\,759$) e \texttt{Sign or Symptom}
($4\,616$) --- refletem a natureza telegráfica e abreviada do texto clínico. Vale
...
caracteres exceda a janela máxima (\texttt{max\_gap}$=20$) e os pares entre
...
($e_1 \neq e_2$), nem entre entidades com \emph{span} idêntico; e \textbf{(v)
...
$\approx 14{:}1$ é intrínseco à tarefa --- decorre da combinatória de pares de
...
($3{,}31\%$) --- coerente com a mediana de distância de $1$ caractere observada na
EDA. Em \texttt{associated\_with}, ao contrário, a perda é substantiva: $132$ de
...
modelos --- todos recebem exatamente os mesmos candidatos ---, ele limita o
