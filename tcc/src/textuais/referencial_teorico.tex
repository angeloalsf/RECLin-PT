...
sustentam estratégias análogas, adotadas neste trabalho como \emph{baseline}.
...
entre interpretabilidade e desempenho, servindo de \emph{sanity check} antes de
modelos mais custosos. Sua principal limitação é a representação de palavras como
unidades independentes, incapaz de capturar dependências de longo alcance e
contexto.
