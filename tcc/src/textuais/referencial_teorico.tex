...
de contexto, ele classifica achados como negados ou afirmados. Sua simplicidade e
...
Para o português, os candidatos naturais à extração de relações clínicas dividem-se
entre modelos de \textbf{domínio geral} e modelos \textbf{adaptados ao domínio
clínico}. No primeiro grupo está o \textbf{BERTimbau} \cite{souza_2020_bertimbau},
pré-treinado no corpus brWaC\footnote{O brWaC
(\foreignlanguage{english}{Brazilian Portuguese Web as Corpus}) é um corpus de
larga escala construído a partir de páginas web em português brasileiro, sem
restrição de domínio.} e hoje a referência de domínio geral para a língua;
nele também se enquadram modelos multilíngues como o \textbf{XLM-R}
\cite{conneau_2020_xlmr}, que trocam especialização por cobertura ampla de idiomas.
No segundo grupo está o \textbf{BioBERTpt} \cite{schneider_2020_biobertpt},
adaptado a narrativas clínicas e textos biomédicos em português brasileiro. É o
contraste entre esses dois grupos que estrutura a proposta deste trabalho, que
compara o BioBERTpt ao BERTimbau sob paridade total de implementação; o XLM-R
permanece como alternativa de base ampla, relevante ao panorama, mas fora do
escopo experimental aqui delimitado.
